...
{
    decoder->frame.message_type = PROTOCOL_MESSAGE_TYPE_INVALID;
    ...
    *frame = NULL;
    ...
    switch (decoder->state)
    {
        ...
        case PROTOCOL_DECODER_READ_VERSION:
            ...
            decoder->state =
                PROTOCOL_DECODER_READ_MESSAGE_TYPE;
            break;

        case PROTOCOL_DECODER_READ_MESSAGE_TYPE:
            decoder->frame.message_type = byte;
        ...
        case PROTOCOL_DECODER_READ_SEQUENCE_HIGH:
            decoder->frame.sequence = (uint16_t)byte << 8U;
